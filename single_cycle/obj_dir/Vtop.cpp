...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_sw{vlSymsp->TOP.io_sw}
    , io_lcd{vlSymsp->TOP.io_lcd}
    , io_ledg{vlSymsp->TOP.io_ledg}
    , io_ledr{vlSymsp->TOP.io_ledr}
    , io_hex0{vlSymsp->TOP.io_hex0}
    , io_hex1{vlSymsp->TOP.io_hex1}
    , io_hex2{vlSymsp->TOP.io_hex2}
    , io_hex3{vlSymsp->TOP.io_hex3}
    , io_hex4{vlSymsp->TOP.io_hex4}
    , io_hex5{vlSymsp->TOP.io_hex5}
    , io_hex6{vlSymsp->TOP.io_hex6}
    , io_hex7{vlSymsp->TOP.io_hex7}
